...
<div class='form-group'>
    <div class='col-sm-2'>
        Show<br>{{ Form::select('show',array("Contraceptive Type"=>"Contraceptive Type","Contraceptive History"=>"Contraceptive History"),'',array('class'=>'form-control','required'=>'requiered')) }}
    </div>
    <div class='col-sm-2'>
...
<script>
    $(document).ready(function (){
        ...
        $("#table").unbind("click").click(function(){
            ...
            $("#formms").ajaxSubmit({
                url:"<?php echo url('report/contraceptive/table') ?>",
                target: '#chartarea',
                data: {chat:'table'},
        ...
        $("#pie").unbind("click").click(function(){
            ...
            $("#chartarea").html("<h3><i class='fa fa-spin fa-spinner '></i><span>Loading...</span><h3>");
            $("#formms").ajaxSubmit({
                url:"<?php echo url('report/contraceptive/pie') ?>",
                target: '#chartarea',
                data: {chat:'table'},
                success:  afterSuccess
            });
        ...
        $("#bar").unbind("click").click(function(){
            ...
            $("#chartarea").html("<h3><i class='fa fa-spin fa-spinner '></i><span>Loading...</span><h3>");
            $("#formms").ajaxSubmit({
                url:"<?php echo url('report/contraceptive/bar') ?>",
                target: '#chartarea',
                data: {chat:'table'},
                success:  afterSuccess
            });
        ...
        $("#line").unbind("click").click(function(){
            ...
            $("#chartarea").html("<h3><i class='fa fa-spin fa-spinner '></i><span>Loading...</span><h3>");
            $("#formms").ajaxSubmit({
                url:"<?php echo url('report/contraceptive/line') ?>",
                target: '#chartarea',
                data: {chat:'table'},
                success:  afterSuccess
            });
