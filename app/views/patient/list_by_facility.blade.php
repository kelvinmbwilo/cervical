...
<li class="active">{{ Facility::find($id)->facility_name }} Patients</li>
...
<div class="tile-body color blue rounded-corners">
    <div class="row">
        <a href="{{ url('facilities') }}" class="btn btn-primary btn-xs add pull-left" id="add">Back to List <i class="fa fa-list"></i> </a></div>
        <a href="{{ url('patient/register') }}" class="btn btn-primary btn-xs add pull-right" id="add">New Registration <i class="fa fa-plus"></i> </a></div>
